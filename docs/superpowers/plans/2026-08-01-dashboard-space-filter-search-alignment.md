...
- [x] **Step 4: 更新 HTTP mock 和移动/桌面 E2E**

mock venue 返回 `is_default`；新增首页切换测试，断言 URL 不变、数据变化且无横向溢出。

- [x] **Step 5: 运行首页与 E2E 并提交**
