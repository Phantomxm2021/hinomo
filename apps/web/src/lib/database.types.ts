...
export type Database = {
  public: {
    Tables: {
      ...
      items: {
        ...
        Insert: {
          ...
          name: string
          quantity?: number
          // Generated by the AI pipeline; browser writes are denied.
      ...
      packing_sessions: {
        ...
        Insert: {
          ...
          model_id?: string | null
          owner_id: string
          // Captured by create_packing_session from the user's profile.
          output_locale?: never
          photo_count?: number
          processed_at?: string | null
          prompt_version?: string | null
      ...
      packing_search_alias_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: 'packing_search_alias_jobs_detected_item_id_fkey'
            columns: ['detected_item_id']
            isOneToOne: false
            referencedRelation: 'packing_detected_items'
            referencedColumns: ['id']
          },
        ]
      }
    ...
    Functions: {
      ...
      complete_packing_search_alias_job: {
        Args: { p_job_id: string; p_search_aliases: string[] | null }
        Returns: undefined
      }
      ...
      fail_packing_search_alias_job: {
        Args: { p_error_code: string; p_job_id: string; p_retryable?: boolean }
        Returns: undefined
      }
      get_public_box: {
