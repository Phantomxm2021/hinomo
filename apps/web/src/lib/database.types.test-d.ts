...
type PackingItemRow = Database['public']['Tables']['items']['Row']
...
declare const packingSession: Omit<PackingSessionRow, 'output_locale'>
const zhSession: PackingSessionRow = { ...packingSession, output_locale: 'zh-CN' }
const enSession: PackingSessionRow = { ...packingSession, output_locale: 'en-US' }
const itemAliases: PackingItemRow['search_aliases'] = ['键盘', 'keyboard']
const detectedItemAliases: PackingDetectedItemRow['search_aliases'] = ['键盘', 'keyboard']
const itemUpdateWithAliases: PackingItemUpdate = {
  // @ts-expect-error Search aliases are generated by the AI pipeline and are not browser-writable.
  search_aliases: itemAliases,
}
const validAliasJob: AliasJob = {
  alias_version: 'packing-alias-v1',
  attempts: 1,
  category: '电子设备',
  detected_item_id: '00000000-0000-0000-0000-000000000001',
