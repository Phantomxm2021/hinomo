...
test('publishes the venue-sharing privacy, optional analytics, and responsibility boundaries in both languages', () => {
  ...
  expect(screen.getByRole('main')).toHaveTextContent('当前标示价格为 US$9')
  expect(screen.getByRole('main')).not.toHaveTextContent('HK$38')
  ...
  expect(screen.getByRole('main')).toHaveTextContent('Its currently displayed price is US$9')
  expect(screen.getByRole('main')).not.toHaveTextContent('HK$38')
