...
beforeEach(() => {
  ...
  mockListVenues.mockResolvedValue([
    { id: 'home', name: '家里', description: '常住地址', is_default: true, space_count: 3 },
    { id: 'office', name: '公司', description: null, is_default: false, space_count: 1 },
  ])
})
...
test('lists venues and opens creation and editing from the dedicated page', async () => {
  ...
  expect(screen.getByRole('button', { name: '编辑场地公司' })).toHaveTextContent('1 个空间 · 未填写描述')
