...
You must have the legal capacity to enter into a binding agreement. If you are below the age of legal majority where you live, you must have a parent or guardian's consent and use the service under their guidance.

## 2. Accounts and security

- Provide accurate and complete registration information and keep it current.
- Protect your login credentials. Do not share your account or permit unauthorized use.
- You are responsible for activity through your account. If you discover unauthorized use, contact us promptly through the official support channel.

## 3. Service features

Nomo provides venue, space, box, and item management; search; QR codes; image processing; and related features. We may add, modify, or discontinue features as the product develops. When a change materially affects your rights, we will seek to provide reasonable advance notice.

## 4. Your content

You retain your rights in content you submit. You grant us a worldwide, non-exclusive license, limited to what is necessary to operate, maintain, secure, and improve the service, to host, copy, process, and display that content. This license does not permit us to sell your content for purposes unrelated to the service.

You represent that you have the rights necessary to submit and process your content and that it does not violate another person's privacy, intellectual property, or other lawful rights.

## 5. Public sharing and QR codes
...
- Upload malware or disrupt or damage the service;
- Attempt to bypass authentication, credits, access controls, or security restrictions;
- Access, scrape, or collect another person's data without authorization;
