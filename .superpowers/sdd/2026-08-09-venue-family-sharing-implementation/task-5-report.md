...
- The actor-filter assertion additionally requires every returned row to carry the requested actor ID, guarding against a false-positive count-only filter test.
